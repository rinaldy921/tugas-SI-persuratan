    ...
    <div class="container">
        ...
        $this->widget('zii.widgets.CMenu', array(
            ...
            'items' => array(
                ...
                array(
                    'label' => '<i class="fa fa-pencil-square-o fa-2x"></i><span class="menu_label">Data Pokok</span>',
                ...
                array(
                        'label' => '<i class="fa fa-book fa-2x"></i><span class="menu_label">Panduan</span>',
                        'url' => 'https://docs.google.com/uc?export=download&id=14py7OoxbbhGp3gstFjfX0FX-t-omhExE',
