...
// $this->performAjaxValidation($model);
        ...
        if (isset($_POST['PerusahaanCabang'])) {
            $model->attributes = $_POST['PerusahaanCabang'];
            if ($model->save()) {
...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
    ...
    public function actionIndex() {
        ...
        if (isset($_GET['PerusahaanCabang']))
            $model->attributes = $_GET['PerusahaanCabang'];
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'perusahaan-cabang-form') {
