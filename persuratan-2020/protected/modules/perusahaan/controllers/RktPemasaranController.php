...
class RktPemasaranController extends Controller {
...
//
	...
	public function loadModel($id) {
        $model = RktPasar::model()->findByPk($id);
        if ($model === null)
    ...
    public function actionFormRktMatch($rku) {
        $ModelRKU = RkuPasar::model()->findByPk($rku);
        ...
        $ModelRKT = new RktPasar();

        if (isset($_POST['RktPasar'])) {
            $ModelRKT->attributes = $_POST['RktPasar'];
            ...
            $ModelRKT->attributes = array(
                ...
                '_jenis_pemasaran' => $ModelRKU->idJenisPasar->nama_pemasaran,                
                'id_rkt' => $rkt->id,
                'id_pemasaran' => $ModelRKU->id_jenis_pasar,                                
