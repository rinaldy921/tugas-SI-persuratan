...
class RktPemanenanHhbkController extends Controller {
...
//                $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('index'));
	...
	public function loadModel($id) {
        $model = RktPanenHhbk::model()->findByPk($id);
        if ($model === null)
    ...
    public function actionFormRktMatch($rku) {
        $ModelRKU = RkuHasilHutanNonkayu::model()->findByPk($rku);
        ...
        $ModelRKT = new RktPanenHhbk;

        if (isset($_POST['RktPanenHhbk'])) {
            $ModelRKT->attributes = $_POST['RktPanenHhbk'];
    ...
    public function actionPilihRKU($tahun) {
        ...
        $model = new RkuHasilHutanNonkayu('search');
