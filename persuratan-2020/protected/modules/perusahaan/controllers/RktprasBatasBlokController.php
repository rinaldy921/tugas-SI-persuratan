...
class RktprasBatasBlokController extends Controller {
    ...
    public function actionDeleteBatas($id) {
        if (Yii::app()->request->isPostRequest) {
            ...
            RktTataBatas::model()->findByPk($id)->delete();
    ...
    public function actionEditJumlahBatas() {
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'batas-rkt-form') {
