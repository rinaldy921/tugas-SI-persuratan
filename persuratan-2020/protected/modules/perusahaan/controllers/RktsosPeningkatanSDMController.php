...
class RktsosPeningkatanSDMController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array(
                    'deletePeningkatanSDM',
                    'editJumlahPeningkatanSDM',
                    'daftarPeningkatanSDM',
                ),
                'users' => array(Yii::app()->user->perusahaanRole()),
            ),
    ...
    public function actionDaftarPeningkatanSDM($rkt) {
        // debug($rkt);
        $model = new RktPeningkatanSdm;
        ...
        //$new_tata_batas = new RktPeningkatanSdm;
        //$new_tata_batas->id_rkt = $rkt;

        if (isset($_POST['RktPeningkatanSdm'])) {
            $model->attributes = $_POST['RktPeningkatanSdm'];
            if ($model->save()) {
    ...
    public function actionDeletePeningkatanSDM($id) {
        if (Yii::app()->request->isPostRequest) {
            // we only allow deletion via POST request
            RktPeningkatanSdm::model()->findByPk($id)->delete();
    ...
    public function actionEditJumlahPeningkatanSDM() {
