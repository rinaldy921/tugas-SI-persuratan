...
class RktprasArealEfektifController extends Controller {
    ...
    public function actionDaftarArealEfektif($rkt) {
        // debug($rkt);
        $model = new RktArealProduktif;
        ...
        //$new_tata_batas = new RktArealProduktif;
        //$new_tata_batas->id_rkt = $rkt;

        if (isset($_POST['RktArealProduktif'])) {
            $model->attributes = $_POST['RktArealProduktif'];
            if ($model->save()) {
    ...
    public function actionDeleteArealEfektif($id) {
        if (Yii::app()->request->isPostRequest) {
            // we only allow deletion via POST request
            RktArealProduktif::model()->findByPk($id)->delete();
    ...
    public function actionEditJumlahArealEfektif() {
