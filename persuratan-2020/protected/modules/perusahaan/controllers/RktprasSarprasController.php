...
class RktprasSarprasController extends Controller {
    ...
    public function actionIndex($rkt) {
  	...
  	public function actionDeleteSarpras($id) {
        if (Yii::app()->request->isPostRequest) {
            ...
            RktSarpras::model()->findByPk($id)->delete();
    ...
    public function actionEditJumlahSarpras() {
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'prasyarat-rkt-form') {
