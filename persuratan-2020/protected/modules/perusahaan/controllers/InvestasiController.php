...
//            $model = array();
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Investasi']))
		{
			$_POST['Investasi']['jml_rupiah'] = (double) str_replace(".", "", $_POST['Investasi']['jml_rupiah'] );
			$_POST['Investasi']['jml_dollar'] = (double) str_replace(".", "", $_POST['Investasi']['jml_dollar'] );
			$model->attributes=$_POST['Investasi'];
			$model->id_perusahaan = Yii::app()->user->idPerusahaan();
			if($model->save())
	...
	{
		$this->layout = false;
		$dataProvider=new CActiveDataProvider('Investasi');
	...
	public function actionAdmin()
	{
		$model=new Investasi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Investasi']))
			$model->attributes=$_GET['Investasi'];
	...
	{
		$model=Investasi::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='investasi-form')
		{
