...
class RktsosInfraMukimController extends Controller {
    ...
    public function actionDaftarInfraMukim($rkt) {
        //debug($rkt);
        ...
        //$new_tata_batas = new RktInfraMukim;
    ...
    public function actionDeleteInfraMukim($id) {
        if (Yii::app()->request->isPostRequest) {
            // we only allow deletion via POST request
            RktInfraMukim::model()->findByPk($id)->delete();
    ...
    public function actionEditJumlahInfraMukim() {
