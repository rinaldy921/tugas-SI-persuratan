...
class RktlingPerlindunganHutanController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array(
                    'deletePerlindunganHutan',
                    'editJumlahPerlindunganHutan',                    
                ),
                'users' => array(Yii::app()->user->perusahaanRole()),
            ),
    ...
    public function actionIndex($rkt) {
        ...
        //$new_tata_batas = new RktLingkunganDungtan;
  	...
  	public function actionDeletePerlindunganHutan($id) {
        if (Yii::app()->request->isPostRequest) {
            // we only allow deletion via POST request
            RktLingkunganDungtan::model()->findByPk($id)->delete();
    ...
    public function actionEditJumlahPerlindunganHutan() {
        Yii::import('booster.components.TbEditableSaver');
        $model = new TbEditableSaver('RktLingkunganDungtan');
        $model->update();
    }
