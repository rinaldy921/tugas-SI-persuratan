...
class RktprasPembukaanWilayahController extends Controller {
    ...
    public function actionIndex($rkt) {
  	...
  	public function actionDeletePembukaanWilayah($id) {
    ...
    public function actionEditJumlahPwh() {
