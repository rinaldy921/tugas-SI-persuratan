...
class RktsosPenangananKonflikController extends Controller {
    ...
    public function actionIndex($rkt) {
        ...
        //$new_tata_batas = new RktKonflikSosial;
        //$new_tata_batas->id_rkt = $rkt;
        
        if (isset($_POST['RktKonflikSosial'])) {
            $model->attributes = $_POST['RktKonflikSosial'];
            if ($model->save()) {
    ...
    public function actionDeletePenangananKonflik($id) {
        if (Yii::app()->request->isPostRequest) {
            // we only allow deletion via POST request
            RktKonflikSosial::model()->findByPk($id)->delete();
    ...
    public function actionEditJumlahPeralatan() {
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'peralatan-rkt-form') {
