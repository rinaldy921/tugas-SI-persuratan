...
class RktSarprasController extends Controller
{
    /**
    ...
    */
    ...
    {
        $model=new RktSarpras('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['RktSarpras']))
        $model->attributes=$_GET['RktSarpras'];
    ...
    */
    ...
    {
        if(isset($_POST['ajax']) && $_POST['ajax']==='rkt-sarpras-form')
        {
