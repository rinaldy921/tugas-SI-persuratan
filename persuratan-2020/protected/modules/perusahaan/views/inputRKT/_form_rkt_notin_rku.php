...
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id' => 'rkt-tanam-dismatch-rku-form',
    'type' => 'horizontal',
...
<?php echo CHtml::activeHiddenField($model, 'id_rkt_tanam_alasan'); ?>
...
<script type="text/javascript">
    ...
    function simpanTanamNotRelated()
    {
        ...
        var form = new FormData($("#rkt-tanam-dismatch-rku-form")[0]);
        $.ajax({
            type: "POST",
            data: form,
            dataType: "json",
            contentType: false,
            processData: false,
            url: "<?= Yii::app()->createUrl("/perusahaan/inputRKT/formRktDismatchRKU/alasan/".$alasan."/tahun/".$tahun) ?>",
