<script type="text/javascript">
    function generateTable(){
        ...
        temp += '</tr>';
        $('#<?=Yii::app()->controller->id?>-kerjasama-koperasi-grid table thead').prepend(temp);
    }
    generateTable();
</script>
<!--<style media="screen">
...
<?php $box = $this->beginWidget(
    ...
    array(
        'title' => 'Kerjasama Koperasi',
        'headerIcon' => 'save',
        'padContent' => false
    )
);?>
<center><h3>Kerjasama Koperasi</h3></center>
<?php $this->widget('booster.widgets.TbGridView',array(
    ...
    'columns'=>array(
    	...
    	array(
    		...
    		'editable'=> array('url'=>$this->createUrl('//perusahaan/realisasiKerjasamaKoperasi/inputRealisasi'),
//    			'success'=>'js:function(){
//                            $.fn.yiiGridView.update("-kerjasama-koperasi-grid");
//                    $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-kerjasama-koperasi-grid",{data:"aksi=updateGrid&tahun='. $tahun .'&id_bulan='. $id_bulan .'&tahun_periode='. $tahun_periode .'",complete:function(){
//                        setTimeout(function(){
//                            generateTable();
//                        }, 100)
//                    }});
