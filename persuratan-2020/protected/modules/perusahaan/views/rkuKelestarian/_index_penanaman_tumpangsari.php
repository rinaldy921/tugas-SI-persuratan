<br />
<button onclick="show_form_tumpangsari()" type="button" name="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</button>
...
//        ),        
        ...
        array(
            ...
            'headerHtmlOptions' => array('style' => 'text-align:center; vertical-align:middle'),
            'value' => '$data->idJenisTumpangsari->nama',
            'htmlOptions' => array('style' => 'text-align:center; vertical-align:middle')
        ),
        ...
        array(
            ...
            'type' => 'raw',
            'editable' => array(
                'url' => $this->createUrl('//perusahaan/rkuKelestarian/inputTumpangsari'),
                'success'=>'js:function() {
        ...
        array(
                ...
                'value'=>function($data){
					...
					'onclick'=>'editTanam(this)', 
                                        'data-url'=> Yii::app()->createUrl("/perusahaan/rkuKelestarian/addTumpangsari",array("id_rku"=>'','id_tanam'=>$data->id)),
                            ));
			},
                'htmlOptions' => array('style' => 'text-align:center; vertical-align:middle')
        ),
...
<script type="text/javascript">
       ...
       function show_form_tumpangsari(id = '')
    {
        var url = "<?php echo $this->createUrl('//perusahaan/rkuKelestarian/addTumpangsari', array('id_rku' => $rku->id_rku)); ?>id_tanam/" + id;
        var title = "Tambah Data Penanaman Tumpangsari";
        showModal(url, title);
    }
