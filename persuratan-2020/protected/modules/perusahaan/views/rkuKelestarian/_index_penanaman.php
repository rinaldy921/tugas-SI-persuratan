...
<button onclick="show_form_tumpangsari()" type="button" name="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Tumpangsari</button>
<?php
...
<script type="text/javascript">
    ...
    {
        var url = "<?php echo $this->createUrl('//perusahaan/rkuKelestarian/addPenanaman', array('id_rku' => $rku->id_rku)); ?>id_tanam/" + id;
        var title = "Tambah Data Tumpangsari";
        showModal(url, title);
    }
