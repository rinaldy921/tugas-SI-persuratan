        ...
        array(
            ...
            'buttons' => array(
                'pilih' => array(
                    ...
                    'url' => function($data){
                        return 'javascript:toggleFormRKTByRKU("#select-rku","#form-rkt","'.$this->createUrl('//perusahaan/rktPemeliharaan/formRktMatch/rku/'.$data->id).'");';
                    },
                ),
            ),
            'headerHtmlOptions' => array('style' => 'text-align:center; vertical-align:middle'),
