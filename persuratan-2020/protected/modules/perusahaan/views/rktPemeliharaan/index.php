...
//            'value' => '!empty($data->jumlah) ? number_format($data->jumlah,2,",",".") : ""',
            'editable' => array(
                'url' => $this->createUrl('//perusahaan/rktPemeliharaan/inputJumlahPemeliharaan'),
                'success' => 'js:function() {
	                $.fn.yiiGridView.update("rkt-penanaman-grid-rku-match",{data:"aksi=updateGrid&tahun=' . $tahun . '"});
	            }'
            ),
            'htmlOptions' => array('style' => 'text-align:right'),
            'footer' => '<strong>'.number_format(RktPelihara::model()->getTotal($model->findRkuMatch()->getData(), 'jumlah'),2,",",".") . '</strong>',
...
//          'value' => '!empty($data->jumlah) ? number_format($data->jumlah,2,",",".") : ""',
            ...
            'htmlOptions' => array('style' => 'text-align:right'),
            'footer' => '<strong>'.number_format(RktPelihara::model()->getTotal($model->findRkuDismatch()->getData(), 'jumlah'),2,",",".") . '</strong>',
            'footerHtmlOptions' => array('style' => 'text-align:right; vertical-align:middle'),
        ),
        array(
            'header' => 'Keterangan',
...
<script type="text/javascript">
    ...
    function show_form_alasan()
    {
        ...
        var url = "<?php echo $this->createUrl('//perusahaan/rktPemeliharaan/entryAlasan'); ?>" + "tahun/" + thn;
    ...
    function entry_rkt_by_rku()
    {
        var thn = $("#Rkt_tahun_mulai").val();
        //alert(thn);
        var url = "<?php echo $this->createUrl('//perusahaan/rktPemeliharaan/pilihRKU'); ?>" + "tahun/" + thn;
