...
<?php echo $form->textFieldGroup($model, '_jenis_pemeliharaan', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 50, 'readonly' => true)))); ?>
...
<?php echo CHtml::activeHiddenField($model, 'id_rku_pelihara'); ?>
...
<?php echo CHtml::activeHiddenField($model, 'id_jenis_pemeliharaan'); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        $this->widget('booster.widgets.TbButton', array(
            ...
            'htmlOptions' => array('onclick' => 'toggleFormRKTByRKU("#form-rkt","#select-rku","'.$this->createUrl('//perusahaan/rktPemeliharaan/pilihRKU/tahun/'.$modelRKU->tahun).'")'),
        ));
        ?>
    </div>
</div>
...
<script type="text/javascript">
    function simpanRKT()
    {
        ...
        $.ajax({
            ...
            contentType: false,
            processData: false,
            url: "<?= Yii::app()->createUrl("/perusahaan/rktPemeliharaan/formRktMatch/rku/".$modelRKU->id); ?>",
