...
$select_jenpem = MasterJenisPemeliharaan::model()->findAll();
$list_jenpem = CHtml::listData($select_jenpem, 'id', 'jenis_pemeliharaan');
...
<?php echo $form->select2Group($model, 'id_jenis_pemeliharaan', array('groupOptions' => array('id' => "jenis_pemeliharaan"), 'widgetOptions' => array('options' => array('allowClear' => true), 'data' => $list_jenpem, 'htmlOptions' => array('class' => 'form-control ', 'placeholder' => Yii::t('app', 'Pilih Jenis Pemeliharaan'))))); ?>
...
<script type="text/javascript">
    ...
    function simpanRKT()
    {
        ...
        $('#RktPelihara_rkt_ke_new').val($('#Rkt_tahun_mulai').val());
        ...
        $.ajax({
            ...
            contentType: false,
            processData: false,
            url: "<?= Yii::app()->createUrl("/perusahaan/rktPemeliharaan/formRktDismatch/alasan/" . $alasan . "/tahun/" . $tahun) ?>",
