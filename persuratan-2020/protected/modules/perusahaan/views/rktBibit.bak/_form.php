...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldGroup($model,'id_jenis_produksi_lahan',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

	<?php echo $form->textFieldGroup($model,'id_jenis_tanaman',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
