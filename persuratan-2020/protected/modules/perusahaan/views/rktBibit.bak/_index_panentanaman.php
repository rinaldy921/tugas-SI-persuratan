    ...
    <?php
        ...
        $result = RktPanenVolumeTanaman::model()->findAll($criteria);
    ...
    <div class="col-md-5" style="margin-bottom:10px">
        <div class="form-group has-success">
            ...
            <div class="col-sm-9">
                <select class="input-large form-control" placeholder="Jenis Legalitas" id="panenvolumetanaman" onchange="panenvolumetanaman()">
                    <?=$op?>
                </select>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function panenvolumetanaman()
        {
            var s = $("#panenvolumetanaman").val();
            console.log(s);
             $.fn.yiiGridView.update("<?=Yii::app()->controller->id?>-panenvolumetanaman-grid",{data:"aksi=panenvolumetanaman&tahun=<?=$tahun?>&sektor="+s});
        }
    </script>


<?php $this->widget('booster.widgets.BootGroupGridView',array(
'id'=>Yii::app()->controller->id . '-panenvolumetanaman-grid',
...
'columns'=>array(
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/rktBibit/inputJumlahPanenTanaman'),
				'success'=>'js:function() {
	                $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-panenvolumetanaman-grid",{data:"aksi=updateGrid&tahun='.$tahun.'"});
	            }',
