...
<center><h3>Pendangiran</h3></center>
<?php $this->widget('booster.widgets.TbGridView',array(
    ...
    'columns'=>array(
        array(
            ...
            'value'=>'$data->idRktDangir->idJenisProduksiLahan->jenis_produksi',
        ...
        array(
            'header'=>'Rencana (Ha)',
            'headerHtmlOptions' => array('class' => 'hidden'),
            'value'=>'isset($data->idRktDangir->jumlah) ? number_format($data->idRktDangir->jumlah,2,",",".") : "0"',
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/realisasiPendangiran/inputJumlahSulam'),
				'success'=>'js:function(){
