...
'columns'=>array(
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/rktInfraMukim/inputJumlahInfraMukim'),
				'success'=>'js:function() {
                    $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-inframukim-grid",{data:"aksi=updateGrid&tahun='.$tahun.'"});
                }'
			),
