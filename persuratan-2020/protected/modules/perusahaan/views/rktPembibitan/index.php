...
//            'value' => '!empty($data->jumlah) ? number_format($data->jumlah,0,",",".") : ""',
            ...
            'footer' => '<strong>'.number_format(RktBibit::model()->getTotal($model->findRkuMatch()->getData(), 'jumlah'),0,",",".") . '</strong>',
...
$this->widget('booster.widgets.BootGroupGridView', array(
    ...
    'enableSorting' => false,
// 'mergeColumns' => array('Sektor', 'Blok', 'id_jenis_produksi_lahan', 'id_jenis_lahan'),
// 'filter'=>$model,
    'template' => '{items}{pager}',
    'columns' => array(
        array(
...
<script type="text/javascript">
    ...
    function show_form_alasan()
    {
        ...
        var url = "<?php echo $this->createUrl('//perusahaan/rktPembibitan/entryAlasan'); ?>" + "tahun/" + thn;
    ...
    function entry_rkt_by_rku()
    {
        var thn = $("#Rkt_tahun_mulai").val();
        //alert(thn);
        var url = "<?php echo $this->createUrl('//perusahaan/rktPembibitan/pilihRKU'); ?>" + "tahun/" + thn;
