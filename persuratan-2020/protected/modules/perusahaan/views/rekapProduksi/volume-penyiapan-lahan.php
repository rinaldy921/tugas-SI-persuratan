...
<script type="text/javascript" src="<?=Yii::app()->createUrl('/js');?>orbjs/dist/orb.js"></script>	
   ...
   <style type="text/css">
    ...
    <h4 style="margin-top: 2em; text-align: center">Rekapitulasi Pemanenan (Volume Produksi Penyiapan Lahan - LOA &AMP; Non LOA) Periode RKT <?=$tahun;?></h4>
...
<script type="text/javascript">
    ...
    var config = {
        ...
        fields: [
            ...
            {
                name: 'jenis_rencana',
                caption: 'Jenis Kelompok Kayu - Rencana (M3)',
                sort: {
                    order: 'asc'
                },
                rowSettings: {
            ...
            {
                name: 'nama_kelompok',
                caption: 'Jenis Kelompok Kayu',
            }
        ],
        rows    : ['nama_kayu','nama_kelompok','periode',],//, 'Category' ],
