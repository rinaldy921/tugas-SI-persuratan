...
<div id="tabs_rekap2">
    <ul id="list_tabs2" class="nav nav-tabs">
        <li class="active">
            <?php
            echo CHtml::link("Pemasaran Hasil Hutan", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapProduksi/pemasaran'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
        ...
        <li>
            <?php
            echo CHtml::link("Pemasaran Hasil Hutan NonKayu", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapProduksi/pemasaranHhbk'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilContent2(this)"
            ));
