...
<script type="text/javascript" src="<?=Yii::app()->createUrl('/js');?>orbjs/dist/orb.js"></script>	
   ...
   <style type="text/css">
    ...
    <h4 style="margin-top: 2em; text-align: center">Rekapitulasi Pemanenan (Volume Produksi Hasil Tanaman) Periode RKT <?=$tahun;?></h4>
...
<script type="text/javascript">
    ...
    var config = {
        ...
        fields: [
            ...
            {
                name: 'jenis_rencana',
                caption: 'Jenis Tanaman - Rencana (M3)',
                sort: {
                    order: 'asc'
                },
                rowSettings: {
        ...
        rows    : ['jenis_lahan','jenis_produksi', 'nama_blok','periode',],//, 'Category' ],
