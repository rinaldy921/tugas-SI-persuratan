...
<script type="text/javascript" src="<?=Yii::app()->createUrl('/js');?>orbjs/dist/orb.js"></script>	
   ...
   <style type="text/css">
    ...
    <h4 style="margin-top: 2em; text-align: center">Rekapitulasi Penanaman Periode RKT <?=$tahun;?></h4>
...
<script type="text/javascript">
    ...
    var config = {
        ...
        fields: [
            ...
            {
                name: 'rencana',
                caption: 'Unit Kelestarian/Petak Kerja - Jenis Tanaman - Jumlah(Ha)',
                sort: {
                    order: 'asc'
                },
                rowSettings: {
...
//        rows    : ['jenis_lahan','jenis_produksi', 'periode'],//, 'Category' ],
