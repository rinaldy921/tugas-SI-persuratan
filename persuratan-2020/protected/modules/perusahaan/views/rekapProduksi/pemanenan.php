    ...
    <ul id="list_tabs2" class="nav nav-tabs">
        <li class="active">
            ...
            echo CHtml::link("Pemanenan RKT", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapProduksi/pemanenanRkt'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
        ...
        <li>
            ...
            echo CHtml::link("Pemanenan Penyiapan Lahan", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapProduksi/panenLahan'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilContent2(this)"
            ));
        ...
        <li>
            ...
            echo CHtml::link("Pemanenan Hasil Hutan Bukan Kayu", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapProduksi/panenHhbk'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilContent2(this)"
            ));
