...
<script type="text/javascript">
    function generateTable() {
        ...
        temp += '</tr>';
        $('#<?= Yii::app()->controller->id ?>-naker-tetap-grid table thead').prepend(temp);
    }
    generateTable();
</script>
<?php
...
//                'success' => 'js:function(){
//                    $.fn.yiiGridView.update("' . Yii::app()->controller->id . '-naker-tetap-grid",{data:"aksi=updateGrid&tahun=' . $tahun . '&id_bulan=' . $id_bulan . '&tahun_periode=' . $tahun_periode . '",complete:function(){
//                        setTimeout(function(){
//                            generateTable();
//                        }, 100)
//                    }});
