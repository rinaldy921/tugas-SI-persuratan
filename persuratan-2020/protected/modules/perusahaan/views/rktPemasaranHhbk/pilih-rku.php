        ...
        array(
            ...
            'buttons' => array(
                'pilih' => array(
                    ...
                    'url' => function($data){
                        return 'javascript:toggleFormRKTByRKU("#select-rku","#form-rkt","'.$this->createUrl('//perusahaan/rktPemasaranHhbk/formRktMatch/rku/'.$data->id).'");';
                    },
                ),
            )
        )
