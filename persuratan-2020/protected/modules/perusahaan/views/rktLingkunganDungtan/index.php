...
<div id="page-wrapper" class="col-md-9">
    ...
    <div id="tabs_rekap">
        <ul id="list_tabs" class="nav nav-tabs">
            <li class="active">
                <?php
                echo CHtml::link("Perlindungan dan Pengamanan Hutan", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rktlingPerlindunganHutan/index',array('rkt'=>$idRkt,)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
            ...
            <li>
                <?php
                echo CHtml::link("Pengendalian Hama dan Penyakit", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rktlingPengendalianHama/index',array('rkt'=>$idRkt,)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Pengendalian Kebakaran", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rktlingPengendalianKebakaran/index',array('rkt'=>$idRkt,)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                <?php
                echo CHtml::link("Pengelolaan dan Pemantauan Lingkungan", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rktlingPemantauanLingkungan/index',array('rkt'=>$idRkt,)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
