...
'columns'=>array(
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/rktLingkunganDungtan/inputJumlahDalkar'),
				'success'=>'js:function() {
	                $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-dalkar-grid",{data:"aksi=updateGrid&tahun='.$tahun.'"});
	            }'
			),
