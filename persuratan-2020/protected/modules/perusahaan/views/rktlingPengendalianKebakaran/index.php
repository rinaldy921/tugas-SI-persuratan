<button type="button" class="btn btn-sm btn-info" id="addDalkar">Tambah Data</button>
...
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id' => Yii::app()->controller->id . '-dalmakit-rkt-form',
    'type' => 'horizontal',
...
<div class="panel panel-default">
    ...
    <?php echo $form->textFieldGroup($model, 'nama_dalkar', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')))); ?>

    <?php // echo $form->select2Group($model, 'id_dalkar', array('groupOptions' => array('id' => 'jenis_dalkar'), 'widgetOptions' => array('options' => array('allowClear' => true), 'data' => $list, 'htmlOptions' => array('class' => '', 'placeholder' => 'Pilih Jenis Pengendalian Kebararan')))); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            /* $ajaxOptions = array('dataType' => 'json',
                ...
                'success' => 'js:function(data) {
                            if(data.status == "success"){
                                ...
                                $("#jenis_dalkar").find(".select2-allowclear").removeClass("select2-allowclear");
                                $("#jenis_dalkar").find(".select2-chosen").empty().addClass("select2-default").html("Pilih Jenis Pengendalian Kebakaran");
                            } else {
            ...
            $this->widget('booster.widgets.TbButton', array(
                ...
                'size' => 'small',
                'url' => Yii::app()->createUrl('/perusahaan/rktlingPengendalianKebakaran/index/rkt/'.$id_rkt)
            )); */
			...
			Yii::app()->clientScript->registerScript("submitForm", "
				...
				$( '#".Yii::app()->controller->id . "-dalmakit-rkt-form' ).submit(function() {
            ...
            $this->widget('booster.widgets.TbButton', array(
                ...
                'size' => 'small',
                'htmlOptions'=>array(
                    'onclick'=>'js:$("#jenis_sarpras").find(".select2-allowclear").removeClass("select2-allowclear");$("#jenis_sarpras").find(".select2-chosen").empty().addClass("select2-default").html("Pilih Jenis Pengendalian Kebakaran");',
                ),
...
?>
<?php
Yii::app()->clientScript->registerScript("dalkar", "
$('#addDalkar').click(function() {
    $('#" . Yii::app()->controller->id . "-dalmakit-rkt-form').toggle();
});
