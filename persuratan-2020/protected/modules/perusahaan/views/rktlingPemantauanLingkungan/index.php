<button type="button" class="btn btn-sm btn-info" id="addPemantauanLingkungan">Tambah Data</button>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            /* $ajaxOptions = array('dataType' => 'json',
                ...
                'success' => 'js:function(data) {
                            if(data.status == "success"){
                                ...
                                $("#' . Yii::app()->controller->id . '-tauling-rkt-form")[0].reset();
                            } else {
                                $.each(data, function(key, val) {
                                    $("#' . Yii::app()->controller->id . '-tauling-rkt-form #"+key+"_em_").text(val);
                                    $("#' . Yii:: app()->controller->id . '-tauling-rkt-form #"+key+"_em_").show();
                                });
                            }
                        }'
            );
            $this->widget('booster.widgets.TbButton', array(
                ...
                'size' => 'small',
                'url' => Yii::app()->createUrl('/perusahaan/rktlingPemantauanLingkungan/index/rkt/'.$id_rkt)
            )); */
...
$this->widget('booster.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        /* array(
            ...
            'buttons' => array(
                'delete' => array(
                        'url' => 'Yii::app()->createUrl("/perusahaan/rktlingPemantauanLingkungan/deleteTauling",array("id"=>$data->id))',
                ),
            )
        ), */
		array(
			...
			'value'=>function($data){
				return CHtml::link('<i class="glyphicon glyphicon-trash"></i>','',array(
					...
					'data-url'=> Yii::app()->createUrl("/perusahaan/rktlingPemantauanLingkungan/deleteTauling",array("id"=>$data->id))
				));
			}
		),
    )
...
$('#addPemantauanLingkungan').click(function() {
