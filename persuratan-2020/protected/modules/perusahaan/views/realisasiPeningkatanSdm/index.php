<script type="text/javascript">
    function generateTable(){
        ...
        temp += '</tr>';
        $('#<?=Yii::app()->controller->id?>-sdm-grid table thead').prepend(temp);
    }
    generateTable();
</script>
...
<center><h3>Peningkatan SDM</h3></center>
<?php $this->widget('booster.widgets.TbGridView',array(
    ...
    'columns'=>array(
    	...
    	array(
    		...
    		'editable'=> array('url'=>$this->createUrl('//perusahaan/realisasiPeningkatanSdm/inputRealisasi'),
//    			'success'=>'js:function(){
//                    $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-sdm-grid",{data:"aksi=updateGrid&tahun='. $tahun .'&id_bulan='. $id_bulan .'&tahun_periode='. $tahun_periode .'",complete:function(){
//                        setTimeout(function(){
//                            generateTable();
//                        }, 100)
//                    }});
