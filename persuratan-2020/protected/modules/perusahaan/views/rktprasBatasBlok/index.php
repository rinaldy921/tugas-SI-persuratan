...
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id' => Yii::app()->controller->id . '-batas-rkt-form',
    'type' => 'horizontal',
...
<div class="panel panel-default">
    ...
    <?php echo $form->textFieldGroup($model, 'jumlah', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')), 'append' => ' Km')); ?>
        ...
        $ajaxOptions = array(
                ...
                'success' => 'js:function(data) {
                            if(data.status == "success"){
                                $.fn.yiiGridView.update("' . Yii::app()->controller->id . '-batas-grid");
                                $("#' . Yii::app()->controller->id . '-batas-rkt-form")[0].reset();
                            } else {
            ...
            Yii::app()->clientScript->registerScript("submitForm", "
                ...
                $( '#".Yii::app()->controller->id . "-batas-rkt-form' ).submit(function() {
...
$this->widget('booster.widgets.TbGridView', array(
    'id' => Yii::app()->controller->id . '-batas-grid',
    ...
    'columns' => array(
        ...
        array(
            ...
            'type' => 'raw',
            'editable' => array('url' => $this->createUrl('/perusahaan/rktprasBatasBlok/editJumlahBatas')),
        ),
        array(
            'header'=>'',
            'type'=>'raw',
            'value'=>function($data){
                return CHtml::link('<i class="glyphicon glyphicon-trash"></i>','',array(
                    ...
                    'data-url'=> Yii::app()->createUrl("/perusahaan/rktprasBatasBlok/deleteBatas",array("id"=>$data->id))
                ));
            }
        ),
    )
...
$('#addBatas').click(function() {
    $('#" . Yii::app()->controller->id . "-batas-rkt-form').toggle();
});
