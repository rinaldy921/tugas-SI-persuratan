<div id="tabs_rekap">
    <ul id="list_tabs2" class="nav nav-tabs">
        ...
        <li class="active">
            <?php
            echo CHtml::link("Pemasaran Kayu", "#child_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rktPemasaran/listPemasaranKayu/rkt/' . $rkt),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
        ...
        <li>
            <?php
            echo CHtml::link("Pemasaran HHBK", "#child_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rktPemasaranHhbk/index/rkt/' . $rkt),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilChildContent(this)"
            ));
