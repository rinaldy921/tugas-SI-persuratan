...
<script type="text/javascript">
	...
	function deleteDataMatch(th){
		...
		if (confirm("Apakah anda yakin ingin menghapus item ini ?") == true) {
			...
			jQuery('#rkt-pak-grid-rku-match').yiiGridView('update', {
				type: 'POST',
				url: urlLink,
	...
	function deleteDataDisMatch(th){
		...
		if (confirm("Apakah anda yakin ingin menghapus item ini ?") == true) {
			...
			//var th = this,
			afterDelete = function(){};
			jQuery('#rkt-pak-grid-rku-dismatch').yiiGridView('update', {
				type: 'POST',
				url: urlLink,
				success: function(data) {
					jQuery('#rkt-pak-grid-rku-dismatch').yiiGridView('update');
    ...
    function show_form_alasan()
    {
        ...
        var url = "<?php echo $this->createUrl('//perusahaan/rktPenataanAreal/entryAlasan'); ?>" + "tahun/" + thn;
    ...
    function entry_rkt_by_rku()
    {
        var thn = $("#Rkt_tahun_mulai").val();
        //alert(thn);
        var url = "<?php echo $this->createUrl('//perusahaan/rktPenataanAreal/pilihRKU'); ?>" + "tahun/" + thn;
