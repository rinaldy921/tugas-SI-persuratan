<div id="select-rku">
<h4>Data RKU Penyiapan Lahan</h4>
<?php
        ...
        array(
            ...
            'buttons' => array(
                'pilih' => array(
                    ...
                    'url' => function($data){
                        return 'javascript:toggleFormRKTByRKU("#select-rku","#form-rkt","'.$this->createUrl('//perusahaan/rktPenyiapanLahan/formRktMatch/rku/'.$data->id).'");';
                    },
                ),
            ),
            'htmlOptions' => array('style' => 'text-align:center',)
