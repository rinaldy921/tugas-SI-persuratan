...
if (!$model->isNewRecord) {
    $attachments = Attachment::model()->findAll("Model = 'PetaRKU' AND Model_id = :id", array(':id' => $model->id_rku));
}
...
<div class="form-group">
	<label for="nomorRku">Nomor SK RKU</label>
	<p class="form-control-static"><?php echo $rku->nomor_sk; ?></p>
</div>
	...
	<?php echo $form->textFieldGroup($model,'id_rku',array('groupOptions'=>array('style'=>'display:none'), 'widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','value'=>$rku->id_rku)))); ?>
