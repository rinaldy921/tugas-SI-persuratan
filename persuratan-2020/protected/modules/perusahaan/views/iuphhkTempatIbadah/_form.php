...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldGroup($model,'mesjid',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

	<?php echo $form->textFieldGroup($model,'gereja',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
