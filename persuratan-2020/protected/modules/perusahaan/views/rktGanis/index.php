...
<div id="page-wrapper" class="col-md-9">
    ...
    <div id="tabs_rekap">
        <ul id="list_tabs" class="nav nav-tabs">
            <li class="active">
                <?php
                echo CHtml::link("Organisasi & Tenaga Kerja", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/RktprasTenagaKerja/index',array('rkt'=>$idRkt)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
            ...
            <li>
                ...
                echo CHtml::link("Penataan Batas Blok", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/RktprasBatasBlok/index',array('rkt'=>$idRkt)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Penataan Ruang", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rktprasKawasanLindung/index',array('rkt'=>$idRkt)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Penataan Areal Kerja", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rktPenataanAreal/index',array('rkt'=>$idRkt)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Pembukaan Wilayah Hutan", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/RktprasPembukaanWilayah/index',array('rkt'=>$idRkt)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                <?php
                echo CHtml::link("Pemasukan dan Penggunaan Peralatan", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/RktprasPeralatan/index',array('rkt'=>$idRkt)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Pembangunan Sarana Prasarana", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/RktprasSarpras/index',array('rkt'=>$idRkt)),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
