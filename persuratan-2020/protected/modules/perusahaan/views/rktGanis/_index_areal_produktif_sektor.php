...
<?php $this->widget('booster.widgets.BootGroupGridView', array(
    ...
    'enableSorting'=>false,
    'template' => "{items}",
    'mergeColumns'=>array('sektor','id_blok'),
    ...
    'columns'=>array(
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/rktGanis/inputJumlahArealProduktif'),
				'success'=>'js:function() {
	                $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-arealproduktif-grid",{data:"aksi=updateGrid&tahun='.$tahun.'"});
	            }',
