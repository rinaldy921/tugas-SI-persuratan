...
<?php echo $form->textFieldGroup($model, 'lahan_kering', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')),'append'=>'Ha')); ?>

<?php echo $form->textFieldGroup($model, 'basah', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')),'append'=>'Ha')); ?>

<?php echo $form->textFieldGroup($model, 'payau', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')),'append'=>'Ha')); ?>
</div>
