    ...
    $this->beginWidget('booster.widgets.TbTabs', array(
        ...
        'tabs' => array(
            array(
                ...
                'content' => $this->renderPartial('_index_perlindungan', array('model' => $perlindungan, 'addPerlindungan' => $addPerlindungan), true),
//                'active' => true
                //'content' => $this->renderPartial('_index_dunghut', array('hamkit' => $hamkit, 'addHamkit' => $addHamkit, 'tekdam' => $tekdam, 'addTekdam' => $addTekdam, 'addAlatDamkar' => $addAlatDamkar, 'alatDamkar' => $alatDamkar, 'perambahan' => $perambahan, 'addPerambahan' => $addPerambahan), true),
                'active' => true
            ),
            array(
                'label' => 'Pengelolaan dan Pemantauan Lingkungan',
                'content' => $this->renderPartial('_index_pemantauan', array('model' => $pemantauan, 'addPemantauan' => $addPemantauan), true),
//                'active' => true
            )
        ),
    ));
