...
<?php //echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldGroup($model,'tipe_iklim',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

	<?php echo $form->textFieldGroup($model,'curah_hujan',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')),'append'=>'mm')); ?>

	<?php echo $form->textFieldGroup($model,'hujan_terendah',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')),'append'=>'mm')); ?>

	<?php echo $form->textFieldGroup($model,'hujan_tertinggi',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')),'append'=>'mm')); ?>
