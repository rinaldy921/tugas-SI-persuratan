...
$formData = [
    [
        ...
        'uri' => Yii::app()->createUrl('//perusahaan/rekapLingkungan/dungtan')
    ],
    [
        'id' => 'batas_blok',
        'text' => 'Pengendalian Hama & Penyakit',
        'uri' => Yii::app()->createUrl('//perusahaan/rekapLingkungan/hamakit')
    ],
    [
        'id' => 'ruang_lindung',
        'text' => 'Pengendalian Kebakaran',
        'uri' => Yii::app()->createUrl('//perusahaan/rekapLingkungan/kebakaran')
    ]
];
        ...
        <ul id="list_tabs" class="nav nav-tabs">
            <li class="active">
                ...
                echo CHtml::link("Perlindungan & Pengamanan Hutan", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rekapLingkungan/dungtan'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
            ...
            <li>
                ...
                echo CHtml::link("Pengendalian Hama & Penyakit", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rekapLingkungan/hamakit'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Pengendalian Kebakaran", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//perusahaan/rekapLingkungan/kebakaran'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
