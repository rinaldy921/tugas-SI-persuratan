...
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id' => Yii::app()->controller->id . '-batuan-form',
    'type' => 'horizontal',
...
<?php echo $form->textFieldGroup($model, 'nama_batuan', array('groupOptions' => array('class' => ''), 'widgetOptions' => array('htmlOptions' => array('class' => '')))); ?>
