...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldGroup($model,'bertani',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

	<?php echo $form->textFieldGroup($model,'berdagang',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

	<?php echo $form->textFieldGroup($model,'pns',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
