...
<center><h3>Penyulaman</h3></center>
<?php $this->widget('booster.widgets.TbGridView',array(
    ...
    'columns'=>array(
        array(
            ...
            'value'=>'$data->idRktSulam->idJenisProduksiLahan->jenis_produksi',
        ...
        array(
            'header'=>'Rencana (Ha)',
            'headerHtmlOptions' => array('class' => 'hidden'),
            'value'=>'isset($data->idRktSulam->jumlah) ? number_format($data->idRktSulam->jumlah,2,",",".") : "0"',
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/realisasiPenyulaman/inputJumlahSulam'),
				'success'=>'js:function(){
