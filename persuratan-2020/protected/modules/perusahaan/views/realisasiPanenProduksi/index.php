    ...
    'columns'=>array(
            ...
            // ),
             array(
                'header' => 'Daur',
                'name' => 'daur',
                'value'=>'$data->idRktPanenProduksi->daur',
                'headerHtmlOptions' => array('class' => 'hidden'),
                'footer' => '<strong>Total</strong>'
            ),
            array(
                'header' => 'Sektor',
                'name' => 'id_sektor',
                'value'=>'$data->idRktPanenProduksi->idBlok->namaSektor->nama_sektor',
                'headerHtmlOptions' => array('class' => 'hidden'),
            ),
            array(
                'header'=>'Blok',
                'name'=>'id_blok',
                'headerHtmlOptions' => array('class' => 'hidden'),
                'value'=>'$data->idRktPanenProduksi->idBlok->nama_blok',
                'htmlOptions'=>array('style'=>'padding-left:30px'),
            ),
            array(
                'header'=>'Produksi Lahan',
                'value'=>'$data->idRktPanenProduksi->idJenisProduksiLahan->jenis_produksi',
                'headerHtmlOptions' => array('class' => 'hidden'),
            ),
            array(
                'header'=>'Jenis Lahan',
                'name'=>'id_jenis_lahan',
                'headerHtmlOptions' => array('class' => 'hidden'),
                'value'=>'$data->idRktPanenProduksi->idJenisLahan->jenis_lahan',
            ),
        
            array(
                'header'=>'Rencana',
                'headerHtmlOptions' => array('class' => 'hidden'),
                'value'=>'isset($data->idRktPanenProduksi->jumlah_luas) ? number_format($data->idRktPanenProduksi->jumlah_luas,2,",",".") : "0"',
...
//                'headerHtmlOptions' => array('class' => 'hidden'),
            ...
            array(
                'header'=>'Rencana',
                'headerHtmlOptions' => array('class' => 'hidden'),
                'value'=>'isset($data->idRktPanenProduksi->jumlah_produksi) ? number_format($data->idRktPanenProduksi->jumlah_produksi,2,",",".") : "0"',
