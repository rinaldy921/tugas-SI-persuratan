...
'id'=>Yii::app()->controller->id . '-jarang-grid',
...
'columns'=>array(
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/rktBibit/inputJumlahJarang'),
				'success'=>'js:function() {
	                $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-jarang-grid",{data:"aksi=updateGrid&tahun='.$tahun.'"});
	            }',
