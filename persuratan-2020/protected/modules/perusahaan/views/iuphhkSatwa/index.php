...
$this->breadcrumbs=array(
	'Data Satwa Dilindungi'=>array('index'),
	'Manage',
);
...
<div id="page-wrapper" class="col-md-9">
    <h4 class="page-header">Data Satwa Dilindungi</h4>

    <?php
    $list = CHtml::listData(MJenisHewan::model()->findAll(), 'id', 'nama_jenis');
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php echo $form->textFieldGroup($tanaman, 'id_iuphhk', array('groupOptions' => array('class' => 'hidden'), 'widgetOptions' => array('htmlOptions' => array('class' => 'span5','value'=>Yii::app()->user->idIuphhk())))); ?>

            <?php echo $form->select2Group($tanaman, 'id_jenis', array('labelOptions' => array('label' => 'Jenis Hewan'), 'groupOptions' => array('id' => 'jenis_hewan'), 'widgetOptions' => array('options' => array('allowClear' => true), 'data' => $list, 'htmlOptions' => array('class' => '', 'placeholder' => 'Pilih Jenis Hewan')))); ?>

            <?php echo $form->textFieldGroup($model,'nama_satwa',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>100)))); ?>
