<button type="button" class="btn btn-sm btn-info" id="addDalmakit">Tambah Data</button>
<?php
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            $this->widget('booster.widgets.TbButton', array(
                ...
                'size' => 'small',
                'url' => Yii::app()->createUrl('/perusahaan/rktlingPengendalianHama/index/rkt/'.$id_rkt)
            ));
			*/
...
?>
<?php
Yii::app()->clientScript->registerScript("adddalmakit", "
$('#addDalmakit').click(function() {
