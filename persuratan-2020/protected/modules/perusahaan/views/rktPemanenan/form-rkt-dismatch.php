...
<script type="text/javascript">
    ...
    function simpanRKT()
    {
        $('#RktPanenProduksi_rkt_ke_new').val($('#Rkt_tahun_mulai').val());
        ...
        $.ajax({
            ...
            contentType: false,
            processData: false,
            url: "<?= Yii::app()->createUrl("/perusahaan/rktPemanenan/formRktDismatch/alasan/" . $alasan . "/tahun/" . $tahun) ?>",
