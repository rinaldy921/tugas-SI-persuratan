...
<?php echo $form->errorSummary($model); ?>
    ...
    <?php echo $form->dropDownListGroup($model,'predikat', array('widgetOptions'=>array('data'=>array("Mempertahankan Sertifikat PHPL"=>"Mempertahankan Sertifikat PHPL","Mencabut Sertifikat PHPL"=>"Mencabut Sertifikat PHPL"), 'htmlOptions'=>array('class'=>'input-large')))); ?>
    <!-- <?php echo $form->textFieldGroup($model,'dinyatakan',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>255)))); ?> -->
    <?php echo $form->dropDownListGroup($model,'penilikan_ke', array('widgetOptions'=>array('data'=>array("1"=>"1","2"=>"2","3"=>"3","4"=>"4",), 'htmlOptions'=>array('class'=>'input-large')))); ?>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input name="pdf_penilikan_phpl" type="file">
			</div>
            ...
            <?php
                ...
                //{
                    if(!is_null($model->file_doc)) {
                        echo "File Dokumen Penilikan PHPL : <a href='".Yii::app()->createUrl("/").$model->file_doc."' target='_blank' class='btn btn-sm btn-primary'><i class='fa fa-file-pdf-o'></i></a>";
                    }
                //}
            ?>
		</div>
...
<script type="text/javascript">
    ...
    function simpanPenilikan()
    {
        ...
        $.ajax({
            ...
            contentType: false,
            processData: false,
            url: "<?=Yii::app()->createUrl("/perusahaan/sertifikasiPhpl/addPenilikanPHPL",array('id'=>$modelSertifikat->id))?>?id_penilikan=<?=$id_penilikan?>",
