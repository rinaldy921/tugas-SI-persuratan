    		...
    		<div class="col-sm-9">
    			<div class="row">
                    <div class="col-md-6" style="margin-left:-75px">
                        <?php echo $form->datePickerGroup($model,'berlaku',array('widgetOptions'=>array('options'=>array('format'=>'yyyy-mm-dd', 'autoclose'=>true),'htmlOptions'=>array('class'=>'span5')), 'prepend'=>'<i class="glyphicon glyphicon-calendar"></i>','label'=>false)); ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo $form->datePickerGroup($model,'berakhir',array('widgetOptions'=>array('options'=>array('format'=>'yyyy-mm-dd','autoclose'=>true),'htmlOptions'=>array('class'=>'span5')), 'prepend'=>'<i class="glyphicon glyphicon-calendar"></i>','label'=>false)) ?>
                    </div>
                </div>
    		</div>
    	</div>
        <?php echo $form->dropDownListGroup($model,'predikat', array('widgetOptions'=>array('data'=>array("Memenuhi"=>"Memenuhi","Tidak Memenuhi"=>"Tidak Memenuhi"), 'htmlOptions'=>array('class'=>'input-large')))); ?>
        ...
        <div class="form-group">
    		...
    		<div class="col-sm-9">
    			<div class="input-group">
    				<input name="pdf_sertifikat_vlk" type="file">
    			</div>
