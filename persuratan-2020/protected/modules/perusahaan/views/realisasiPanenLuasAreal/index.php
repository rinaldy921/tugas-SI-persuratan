...
<?php $this->widget('booster.widgets.BootGroupGridView',array(
    ...
    'extraRowTotals'=>function($data, $row, &$totals) {
         ...
         $totals['jumlah'] += $data['idRktPanenAreal']['jumlah'];
    ...
    'columns'=>array(
        array(
            ...
            'value'=>'$data->idRktPanenAreal->idJenisLahan->jenis_lahan',
        ...
        array(
            ...
            'headerHtmlOptions' => array('class' => 'hidden'),
            'value'=>'$data->idRktPanenAreal->idProduksiLahan->jenis_produksi',
        ),
        array(
            'header'=>'Blok',
            'name'=>'id_blok',
            'headerHtmlOptions' => array('class' => 'hidden'),
            'value'=>'$data->idRktPanenAreal->idBlok->idBlok->nama_blok',
        ),
        array(
            'header'=>'Jenis Tanaman',
            'headerHtmlOptions' => array('class' => 'hidden'),
            'value'=>'$data->idRktPanenAreal->idJenisTanaman->nama_tanaman'
        ),
        array(
            'header'=>'Rencana (Ha)',
            'value'=>'isset($data->idRktPanenAreal->jumlah) ? number_format($data->idRktPanenAreal->jumlah,2,",",".") : "0"',
            'headerHtmlOptions' => array('class' => 'hidden'),
        ...
        array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/realisasiPanenLuasAreal/inputJumlahTanam'),
				'success'=>'js:function(){
