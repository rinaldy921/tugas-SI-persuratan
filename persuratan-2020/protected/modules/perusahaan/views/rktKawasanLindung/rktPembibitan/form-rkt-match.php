...
<?php echo CHtml::activeHiddenField($model, 'id_rku_bibit'); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        $this->widget('booster.widgets.TbButton', array(
            ...
            'htmlOptions' => array('onclick' => 'toggleFormRKTByRKU("#form-rkt","#select-rku","'.$this->createUrl('//perusahaan/rktPembibitan/pilihRKU/tahun/'.$modelRKU->tahun).'")'),
        ));
        ?>
    </div>
</div>
...
<script type="text/javascript">
    function simpanRKT()
    {
        ...
        $.ajax({
            ...
            contentType: false,
            processData: false,
            url: "<?= Yii::app()->createUrl("/perusahaan/rktPembibitan/formRktMatch/rku/".$modelRKU->id); ?>",
