    ...
    <ul id="list_tabs2" class="nav nav-tabs">
        <li class="active">
            ...
            echo CHtml::link("Pemanenan RKT", "#child_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rktPemanenan/listRktPanenProduksi/rkt/' . $rkt),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
        ...
        <li>
            ...
            echo CHtml::link("Penyiapan Lahan", "#child_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rktPemanenanLahan/index/rkt/' . $rkt),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilChildContent(this)"
            ));
        ...
        <li>
            <?php
            echo CHtml::link("Pemanenan HHBK", "#child_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rktPemanenanHhbk/index/rkt/' . $rkt),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilChildContent(this)"
            ));
