...
'id'=>Yii::app()->controller->id . '-dangir-grid',
...
'columns'=>array(
		...
		array(
			...
			'editable'=> array('url'=>$this->createUrl('//perusahaan/rktBibit/inputJumlahDangir'),
				'success'=>'js:function() {
	                $.fn.yiiGridView.update("'.Yii::app()->controller->id.'-dangir-grid",{data:"aksi=updateGrid&tahun='.$tahun.'"});
	            }',
