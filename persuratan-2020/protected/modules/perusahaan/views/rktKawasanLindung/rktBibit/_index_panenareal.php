    ...
    <?php
        ...
        $result = RktPanenAreal::model()->findAll($criteria);
    ...
    <div class="col-md-5" style="margin-bottom:10px">
        <div class="form-group has-success">
            ...
            <div class="col-sm-9">
                <select class="input-large form-control" placeholder="Jenis Legalitas" id="sektor_penanamanpanenareal" onchange="sektor_penanamanpanenareal()">
                    <?=$op?>
                </select>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function sektor_penanamanpanenareal()
        {
            var s = $("#sektor_penanamanpanenareal").val();
            console.log(s);
             $.fn.yiiGridView.update("<?=Yii::app()->controller->id?>-panenareal-grid",{data:"aksi=filterSektorpanenareal&tahun=<?=$tahun?>&sektor="+s});
        }
    </script>
