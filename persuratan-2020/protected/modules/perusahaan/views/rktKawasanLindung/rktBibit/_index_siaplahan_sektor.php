    ...
    <button style="margin-bottom:10px" onclick="show_form_alasan_siaplahan()" type="button" name="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Buat Data Tidak Sesuai RKU</button>
