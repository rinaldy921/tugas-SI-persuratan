<div id="tabs_rekap">
    <ul id="list_tabs2" class="nav nav-tabs">
        <li>
            <?php
            echo CHtml::link("Pembangunan Penyaluran Infrastruktur Pemukiman", "#child_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rktsosInfraMukim/daftarInfraMukim',array('rkt'=>$rkt,)),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
        ...
        <li  class="active">
            <?php
            echo CHtml::link("Peningkatan SDM", "#child_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rktsosPeningkatanSDM/daftarPeningkatanSDM',array('rkt'=>$rkt,)),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilChildContent(this)"
            ));
