...
$formData = [
    ['id' => 'infra_mukim', 'text' => 'Pembinaan & Pemberdayaan Masyarakat (Pembangunan Penyaluran Infrastruktur Pemukiman)','uri' => Yii::app()->createUrl('//perusahaan/realisasiInfraMukim/index')],
    ['id' => 'ganis', 'text' => 'Pembinaan & Pemberdayaan Masyarakat (Peningkatan SDM)','uri' => Yii::app()->createUrl('//perusahaan/realisasiPeningkatanSdm/index')],
    ['id' => 'kerjasama_koperasi', 'text' => 'Pembinaan Kelembagaan Masyarakat (Kerjasama Koperasi)','uri' => Yii::app()->createUrl('//perusahaan/realisasiKerjasamaKoperasi/index')],
    ['id' => 'bangun_mitra', 'text' => 'Pembinaan Kelembagaan Masyarakat (Kemitraan Usaha)','uri' => Yii::app()->createUrl('//perusahaan/realisasiBangunMitra/index')],
    ['id' => 'konflik_sosial', 'text' => 'Penanganan Konflik Sosial','uri' => Yii::app()->createUrl('//perusahaan/realisasiKonflikSosial/index')],
];
...
<div id="page-wrapper" class="col-md-9">
    <h4 class="page-header">Realisasi RKT - Kelestarian Fungsi Sosial</h4>
    <div class="col-md-12">
        <div class="row">
            <?php
...
<script type="text/javascript">
    $('#<?=$id_grid?>').on('submit',function(){
        var is_empty = 'N';
        $('#<?=$id_grid?>').find('select').each(function(index, elm){
            var select = $(elm).val();
            if(select.length == 0){
                is_empty = 'Y';
            }
