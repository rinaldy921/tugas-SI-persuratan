...
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id' => Yii::app()->controller->id . '-mata-air-form',
    'type' => 'horizontal',
...
<?php echo $form->textFieldGroup($model, 'nama_mata_air', array('groupOptions' => array('class' => ''), 'widgetOptions' => array('htmlOptions' => array('class' => '')))); ?>
