...
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id' => Yii::app()->controller->id . '-waduk-form',
    'type' => 'horizontal',
...
<?php echo $form->textFieldGroup($model, 'nama_waduk', array('groupOptions' => array('class' => ''), 'widgetOptions' => array('htmlOptions' => array('class' => '')))); ?>
