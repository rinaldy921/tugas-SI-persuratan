...
<div id="tabs_rekap2">
    <ul id="list_tabs2" class="nav nav-tabs">
        <li class="active">
            <?php
            echo CHtml::link("Kawasan Lindung", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapPrasyarat/ruangLindung'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
        ...
        <li>
            <?php
            echo CHtml::link("Areal Tidak Efektif", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapPrasyarat/ruangNonEfektif'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilContent2(this)"
            ));
        ...
        <li>
            <?php
            echo CHtml::link("Areal Efektif", "#resuls_content", array(
                "data-uri" => $this->createUrl('//perusahaan/rekapPrasyarat/ruangEfektif'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilContent2(this)"
            ));
