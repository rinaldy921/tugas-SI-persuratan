...
class KeadaanHutanController extends Controller {
    ...
    public function actionIndex($id) {
        ...
        $keadaanhutan = new IuphhkTutupLahan('search');
        $keadaanhutan->unsetAttributes();
        $keadaanhutan->id_iuphhk = $id;

        $this->render('index', array(
            'iuphhk' => $iuphhk,
            'keadaanhutan' => $keadaanhutan,
        ));
    }
