...
'model'=>$model,
	...
	*/
	public function actionUpdate($id)
	{
		...
		$data['oldkab'] = array();
        if (isset($model->kabupaten->provinsi_id) && !empty($model->kabupaten->provinsi_id)) {
            $kab = Kabupaten::model()->findAll(array('select' => 'id_kabupaten, nama', 'condition' => "provinsi_id = " . $model->kabupaten->provinsi_id));
            foreach ($kab as $d) {
