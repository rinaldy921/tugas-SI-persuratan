...
class KelompokHutanController extends Controller {
...
public function actionIndex($id) 
    {
        ...
        $kelompokHutan = new KelompokHutan('search');
        $kelompokHutan->unsetAttributes();
        $kelompokHutan->id_iuphhk = $id;
