...
class TataBatasController extends Controller {
    ...
    public function actionIndex($id) {
        ...
        $progrestatabatas = new ProgresTataBatas('search');
        $progrestatabatas->unsetAttributes();
        $progrestatabatas->id_perusahaan = $model->id_perusahaan;
        ...
        $this->render('index', array(
            'model' => $model,
            'iuphhk' => $iuphhk,
            'progrestatabatas' => $progrestatabatas,
        ));
    }
