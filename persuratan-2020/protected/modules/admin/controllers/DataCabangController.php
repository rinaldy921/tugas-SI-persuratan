...
class DataCabangController extends Controller {
    ...
    public function actionIndex($id) {
        ...
        $perusahaanCabang = new PerusahaanCabang('search');
        $perusahaanCabang->unsetAttributes();
        $perusahaanCabang->perusahaan_id = $model->id_perusahaan;
        ...
        $this->render('index', array(
            'model' => $model,
            'iuphhk' => $iuphhk,
            'perusahaanCabang' => $perusahaanCabang,
        ));
    }
