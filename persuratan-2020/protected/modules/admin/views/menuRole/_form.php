...
<?php //echo $form->textFieldGroup($model, 'id_menu', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 255)))); ?>
<?php echo $form->select2Group($model, 'id_role', array('groupOptions' => array('id' => "id_role"), 'widgetOptions' => array('options' => array('allowClear' => true), 'data' => $list_role, 'htmlOptions' => array('class' => 'form-control ', 'placeholder' => Yii::t('app', 'Pilih Unit Group User/Role...'))))); ?>        
