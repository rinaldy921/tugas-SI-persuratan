...
<div id="page-wrapper" class="col-md-9">
    <h4 class="page-header">Rekapitulasi - Prasyarat</h4>    
    <div class="row">
        <div class="col-md-4">
            <?php
        ...
        <ul id="list_tabs" class="nav nav-tabs">
            <li class="active">
                ...
                echo CHtml::link("Tenaga Teknis", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//admin/rekapPrasyarat/ganis'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
            ...
            <li>
                ...
                echo CHtml::link("Penataan Batas Blok", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//admin/rekapPrasyarat/tataBatas'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Penataan Ruang", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//admin/rekapPrasyarat/penataanRuang'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Penataan Areal Kerja", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//admin/rekapPrasyarat/arealKerja'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Pembukaan Wilayah Hutan", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//admin/rekapPrasyarat/bukaHutan'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Pemasukan & Penggunaan Peralatan", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//admin/rekapPrasyarat/peralatan'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
            ...
            <li>
                ...
                echo CHtml::link("Pembangunan Sarana & Prasarana", "#resuls_content", array(
                    "data-uri" => $this->createUrl('//admin/rekapPrasyarat/sarpras'),
                    "data-toggle" => "tab",
                    "aria-expanded" => "true",
                    "onclick" => "return ambilContent(this)"
                ));
