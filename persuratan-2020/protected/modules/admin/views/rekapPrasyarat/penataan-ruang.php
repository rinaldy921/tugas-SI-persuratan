    ...
    <ul id="list_tabs2" class="nav nav-tabs">
        <li class="active">
            ...
            echo CHtml::link("Kawasan Lindung", "#resuls_content", array(
                "data-uri" => $this->createUrl('//admin/rekapPrasyarat/ruangLindung'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
        ...
        <li>
            ...
            echo CHtml::link("Areal Tidak Efektif", "#resuls_content", array(
                "data-uri" => $this->createUrl('//admin/rekapPrasyarat/ruangNonEfektif'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilContent2(this)"
            ));
        ...
        <li>
            ...
            echo CHtml::link("Areal Efektif", "#resuls_content", array(
                "data-uri" => $this->createUrl('//admin/rekapPrasyarat/ruangEfektif'),
                "data-toggle" => "tab",
                "aria-expanded" => "true",
                "onclick" => "return ambilContent2(this)"
            ));
