...
<?php echo $form->textFieldGroup($model, 'nama_kph', array('labelOptions' => array('label' => 'Nama KPH'), 'widgetOptions' => array('htmlOptions' => array('class' => 'span5', 'maxlength' => 100, 'placeholder' => 'Nama KPH')))); ?>
