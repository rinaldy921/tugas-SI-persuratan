...
$url = Yii::app()->createUrl('admin/report/rku/id/');
$propModel = new Provinsi();
//$listTahun = Rku::model()->getTahun();


 $urlGetTahun = Yii::app()->createUrl("admin/report/gettahunrku"); 
?>
 ...
 <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title">
                <div class="panel-title">RKU IUPHHK-HT</div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                $this->widget('booster.widgets.TbButton', array(
                    ...
                    'context' => 'primary',
                    'label' => 'Tampilkan',
                    'htmlOptions'=> array('onclick' => 'tampilRku()'),
                ));
                echo ' ';
...
<script type="text/javascript">
     function tampilRku(){
        if($('#Rku_id_perusahaan').val() != "" && $('#Rku__tahun').val() != ""){
            idIuphhk = $("#Rku_id_perusahaan option:selected").val();
            tahun = $("#Rku__tahun option:selected").val();

            url = "<?php echo $url; ?>"+idIuphhk+"/tahun/"+tahun;
            title = "RKU IUPHHK";            
