...
'id'=>Yii::app()->controller->id . '-ganis-ditolak-grid',
'type' => 'bordered condensed striped',
'responsiveTable' => true,
'dataProvider'=>$ganisTolak->searchGanisTolak(), 
...
//    
        array(   
            ...
            'value' => '$data[approval_status] == 2 ? "Ditolak" : "Disetujui"'
        ),
		...
		'buttons'=>array(
            ...
            'approve' => array(
            	...
            	'visible' => '$data[approval_status] == 2 ? "1" : "0"'
            ),                              
		)
	),
