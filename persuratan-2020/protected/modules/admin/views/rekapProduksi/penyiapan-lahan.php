...
<script type="text/javascript" src="<?=Yii::app()->createUrl('/js');?>orbjs/dist/orb.js"></script>	
   ...
   <style type="text/css">
    ...
    <h4 style="margin-top: 2em; text-align: center">Rekapitulasi Penyiapan Lahan Periode RKT <?=$tahun;?></h4>
...
<script type="text/javascript">
    ...
    var config = {
        ...
        fields: [
            ...
            {
                name: 'rencana',
                caption: 'Unit Kelesteraian/Petak Kerja - Jenis Produksi Lahan - Rencana (Ha)',
                sort: {
                    order: 'asc'
                },
                rowSettings: {
