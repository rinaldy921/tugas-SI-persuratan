...
<div id="page-wrapper" class="col-md-12">
    ...
    $this->widget('booster.widgets.TbGridView', array(
        ...
        'columns' => array(
            ...
            //     // 'name' => 'nama',
            //     'header' => 'Provinsi',
            //     'value' => '$data->idPerusahaan->iuphhks->admPemerintahans->provinsiFk->nama'
            // ),
            array(
                'header' => 'Last Login',
                'type' => 'raw',
            ...
            array(
                ...
                'buttons' => array(
                    ...
                    // 'profil' => array(
                    //     'options' => array('data-toggle' => 'tooltip', 'title' => 'Lihat Data Perusahaan'),
                    //     'label' => '<i class="fa fa-search"></i>',
                    //     'url' => 'Yii::app()->createUrl("/admin/" . Yii::app()->controller->id . "/view",array("id"=>$data->id_perusahaan))',
                    // ),
                    'iuphhk' => array(
                        'options' => array('data-toggle' => 'tooltip', 'title' => 'Lihat Data IUPHHK-HTI'),
                        'label' => '<i class="fa fa-pencil-square-o"></i>',
                        'url' => 'Yii::app()->createUrl("/admin/dataUmum/",array("id"=>$data->id_iuphhk))',
                        //'url' => 'Yii::app()->createUrl("/admin/dataUmum/",array("id"=>$data->id_iuphhk))',
                    ),
                    'print' => array(
