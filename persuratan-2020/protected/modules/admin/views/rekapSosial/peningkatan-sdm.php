...
<script type="text/javascript" src="<?=Yii::app()->createUrl('/js');?>orbjs/dist/orb.js"></script>	
   ...
   <style type="text/css">
    ...
    <h4 style="margin-top: 2em; text-align: center">Rekapitulasi Perlindungan &AMP; Pemberdayaan Masyarakat <br />Peningkatan SDM Periode RKT <?=$tahun;?></h4>
...
<script type="text/javascript">
    ...
    var config = {
        ...
        fields: [
            ...
            {
                name: 'program_rencana',
                caption: 'Program: Rencana (Unit)',
            }                        
        ],
        rows    : ['periode'],//, 'Category' ],
        columns : ['program_rencana'],
