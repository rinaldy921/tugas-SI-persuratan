...
/**
 * This is the model class for table "pemanfaatan_stok_tanaman".
 *
 * The followings are the available columns in table 'pemanfaatan_stok_tanaman':
 * @property string $id
 * @property string $tahun_tanam
 * @property integer $sektor_id
 * @property integer $blok_id
 * @property double $jumlah_luas
 * @property integer $jenis_pemanfaatan
 * @property integer $id_perusahaan
 */
class PemanfaatanStokTanaman extends CActiveRecord
{
	/**
	...
	{
		return 'pemanfaatan_stok_tanaman';
	}
	...
	public function rules()
	{
		...
		return array(
			array('sektor_id, blok_id, jenis_pemanfaatan, id_perusahaan', 'numerical', 'integerOnly'=>true),
			array('jumlah_luas', 'numerical'),
			array('tahun_tanam', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tahun_tanam, sektor_id, blok_id, jumlah_luas, jenis_pemanfaatan, id_perusahaan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
						...
						'blok_id'=>Yii::t('app','Blok'),
						'jumlah_luas'=>Yii::t('app','Jumlah Luas (Ha)'),
						'jenis_pemanfaatan'=>Yii::t('app','Jenis Pemanfaatan'),
	...
	public function search()
	{
		...
		$criteria->compare('jenis_pemanfaatan',$this->jenis_pemanfaatan);
	 ...
	 * @return PemanfaatanStokTanaman the static model class
	 */
