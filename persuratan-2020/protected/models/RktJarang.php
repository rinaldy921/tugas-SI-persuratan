...
/**
 * This is the model class for table "rkt_jarang".
 *
 * The followings are the available columns in table 'rkt_jarang':
 * @property integer $id
 ...
 * @property Rkt $idRkt
 */
class RktJarang extends CActiveRecord
{
	/**
	 ...
	 * @return RktJarang the static model class
	 */
