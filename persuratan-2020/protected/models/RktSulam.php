...
/**
 * This is the model class for table "rkt_sulam".
 *
 * The followings are the available columns in table 'rkt_sulam':
 * @property integer $id
 ...
 * @property Rkt $idRkt
 */
class RktSulam extends CActiveRecord
{
	/**
	 ...
	 * @return RktSulam the static model class
	 */
