...
/**
 * This is the model class for table "rkt_bangun_mitra".
 *
 * The followings are the available columns in table 'rkt_bangun_mitra':
 * @property integer $id
 ...
 * @property Rkt $idRkt
 */
class RktBangunMitra extends CActiveRecord
{
	/**
	 ...
	 * @return RktBangunMitra the static model class
	 */
