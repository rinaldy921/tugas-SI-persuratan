...
/**
 * This is the model class for table "realisasi_rkt_dangir".
 *
 * The followings are the available columns in table 'realisasi_rkt_dangir':
 * @property integer $id
 * @property integer $id_rkt_dangir
 ...
 * @property RktDangir $idRktDangir
 * @property MasterBulan $idBulan
 */
class RealisasiRktDangir extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_rkt_dangir, id_bulan, tahun, realisasi, persentase, created, updated', 'required'),
			array('id_rkt_dangir, id_bulan', 'numerical', 'integerOnly'=>true),
			array('tahun', 'length', 'max'=>4),
			array('realisasi, persentase', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_rkt_dangir, id_bulan, tahun, realisasi, persentase, created, updated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idRktDangir' => array(self::BELONGS_TO, 'RktDangir', 'id_rkt_dangir'),
	...
	public function attributeLabels()
	{
		return array(
						'id'=>Yii::t('app','ID'),
						'id_rkt_dangir'=>Yii::t('app','Id Rkt Dangir'),
	...
	public function search()
	{
		...
		$criteria->compare('id_rkt_dangir',$this->id_rkt_dangir);
	 ...
	 * @return RealisasiRktDangir the static model class
	 */
	...
	public function searchByRkt()
	{
		...
		$criteria->with = array('idRktDangir');
		$criteria->compare('idRktDangir.id_rkt',$this->id_rkt);
		...
		$criteria->join = 'LEFT JOIN '. $this->tableName() .' bulan_lalu ON
		 	bulan_lalu.id_rkt_dangir = t.id_rkt_dangir AND
		...
		$criteria->group = 't.id_rkt_dangir';
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
		));
	}
	...
	public function getTotalPersen($records, $colName){
    	...
    	$totalRealisasi = 0;
    	foreach($records as $rec){
    		$totalJumlah += $rec->idRktDangir->jumlah;
