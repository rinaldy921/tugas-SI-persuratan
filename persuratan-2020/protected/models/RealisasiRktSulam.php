...
/**
 * This is the model class for table "realisasi_rkt_sulam".
 *
 * The followings are the available columns in table 'realisasi_rkt_sulam':
 * @property integer $id
 * @property integer $id_rkt_sulam
 ...
 * @property RktSulam $idRktSulam
 * @property MasterBulan $idBulan
 */
class RealisasiRktSulam extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_rkt_sulam, id_bulan, realisasi, persentase, created, updated', 'required'),
			array('tahun, id_rkt_sulam, id_bulan', 'numerical', 'integerOnly'=>true),
			array('realisasi, persentase', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tahun, id, id_rkt_sulam, id_bulan, realisasi, persentase, created, updated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idRktSulam' => array(self::BELONGS_TO, 'RktSulam', 'id_rkt_sulam'),
	...
	public function attributeLabels()
	{
		return array(
						'id'=>Yii::t('app','ID'),
						'id_rkt_sulam'=>Yii::t('app','Id Rkt Sulam'),
	...
	public function search()
	{
		...
		$criteria->compare('id_rkt_sulam',$this->id_rkt_sulam);
	 ...
	 * @return RealisasiRktSulam the static model class
	 */
	...
	public function searchByRkt()
	{
		...
		$criteria->with = array('idRktSulam');
		$criteria->compare('idRktSulam.id_rkt',$this->id_rkt);
		...
		$criteria->join = 'LEFT JOIN '. $this->tableName() .' bulan_lalu ON
		 	bulan_lalu.id_rkt_sulam = t.id_rkt_sulam AND
	...
	public function getTotalPersen($records, $colName){
    	...
    	$totalRealisasi = 0;
    	foreach($records as $rec){
    		$totalJumlah += $rec->idRktSulam->jumlah;
