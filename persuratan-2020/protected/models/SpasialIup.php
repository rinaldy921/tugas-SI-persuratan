...
/**
 * This is the model class for table "spasial_iup".
 *
 * The followings are the available columns in table 'spasial_iup':
 * @property integer $id
 ...
 */
class SpasialIup extends CActiveRecord
{
	public $dokumen_peta;
	/**
	 ...
	 * @return SpasialIup the static model class
	 */
