...
/**
 * This is the model class for table "rku_perlindungan_hutan".
 *
 * The followings are the available columns in table 'rku_perlindungan_hutan':
 * @property integer $id
 ...
 * @property Rku $idRku
 */
class RkuPerlindunganHutan extends CActiveRecord
{
	/**
	 ...
	 * @return RkuPerlindunganHutan the static model class
	 */
