...
/**
 * This is the model class for table "rku_fungsos".
 *
 * The followings are the available columns in table 'rku_fungsos':
 * @property integer $id
 ...
 * @property Rku $idRku
 */
class RkuFungsos extends CActiveRecord
{
	/**
	 ...
	 * @return RkuFungsos the static model class
	 */
