...
/**
 * This is the model class for table "iuphhk_data_sungai".
 *
 * The followings are the available columns in table 'iuphhk_data_sungai':
 * @property integer $id
 ...
 */
class DataSungai extends CActiveRecord
{
	/**
	 ...
	 * @return DataSungai the static model class
	 */
