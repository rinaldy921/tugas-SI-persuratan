...
/**
 * This is the model class for table "realisasi_rkt_jarang".
 *
 * The followings are the available columns in table 'realisasi_rkt_jarang':
 * @property integer $id
 * @property integer $id_rkt_jarang
 ...
 * @property RktJarang $idRktJarang
 * @property MasterBulan $idBulan
 */
class RealisasiRktJarang extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_rkt_jarang, id_bulan, tahun, realisasi, persentase, created, updated', 'required'),
			array('id_rkt_jarang, id_bulan', 'numerical', 'integerOnly'=>true),
			array('tahun', 'length', 'max'=>4),
			array('realisasi, persentase', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_rkt_jarang, id_bulan, tahun, realisasi, persentase, created, updated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idRktJarang' => array(self::BELONGS_TO, 'RktJarang', 'id_rkt_jarang'),
	...
	public function attributeLabels()
	{
		return array(
						'id'=>Yii::t('app','ID'),
						'id_rkt_jarang'=>Yii::t('app','Id Rkt Jarang'),
	...
	public function search()
	{
		...
		$criteria->compare('id_rkt_jarang',$this->id_rkt_jarang);
	...
	public function searchByRkt()
	{
		...
		$criteria->with = array('idRktJarang');
		$criteria->compare('idRktJarang.id_rkt',$this->id_rkt);
		...
		$criteria->join = 'LEFT JOIN '. $this->tableName() .' bulan_lalu ON
		 	bulan_lalu.id_rkt_jarang = t.id_rkt_jarang AND
		...
		$criteria->group = 't.id_rkt_jarang';
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return RealisasiRktJarang the static model class
	 */
	...
	public function getTotalPersen($records, $colName){
    	...
    	$totalRealisasi = 0;
    	foreach($records as $rec){
    		$totalJumlah += $rec->idRktJarang->jumlah;
