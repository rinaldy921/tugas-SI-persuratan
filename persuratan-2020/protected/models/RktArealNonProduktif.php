...
/**
 * This is the model class for table "rkt_areal_non_produktif".
 *
 * The followings are the available columns in table 'rkt_areal_non_produktif':
 * @property integer $id
 ...
 * @property Rkt $idRkt
 */
class RktArealNonProduktif extends CActiveRecord
{
	/**
	...
	{
		return 'rkt_areal_non_produktif';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, id_rkt, jumlah, realisasi, persentase', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return RktArealNonProduktif the static model class
	 */
