...
/**
 * This is the model class for table "rkt_evaluasi_pantau_operasional".
 *
 * The followings are the available columns in table 'rkt_evaluasi_pantau_operasional':
 * @property integer $id
 ...
 * @property Rkt $idRkt
 */
class RktEvaluasiPantauOperasional extends CActiveRecord
{
	/**
	...
	{
		return 'rkt_evaluasi_pantau_operasional';
	}
	 ...
	 * @return RktEvaluasiPantauOperasional the static model class
	 */
