...
/**
 * This is the model class for table "rkt_panen_volume_tanaman".
 *
 * The followings are the available columns in table 'rkt_panen_volume_tanaman':
 * @property integer $id
 ...
 * @property Rkt $idRkt
 */
class RktPanenVolumeTanaman extends CActiveRecord
{
	/**
	...
	{
		return 'rkt_panen_volume_tanaman';
	}
	...
	public function attributeLabels()
	{
		return array(
						...
						'jumlah'=>Yii::t('app','Rencana (M3)'),
						'realisasi'=>Yii::t('app','Realisasi (M3)'),
	 ...
	 * @return RktPanenVolumeTanaman the static model class
	 */
